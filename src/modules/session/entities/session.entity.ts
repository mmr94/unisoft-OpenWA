...
export class Session {
  ...
  @Column({ type: dateColumnType(), nullable: true, transformer: DateTransformer })
  // Optional on the TS side (not in the DB): the column is plain nullable, but declaring it
  // required would force every upstream fixture that builds a Session literal to carry it.
