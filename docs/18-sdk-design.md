...
| Resource    | Methods                                                                                                                                                                                                                                                                                                  |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `sessions`  | list, get, getConfig, updateConfig, getProxy, updateProxy, create, delete, start, stop, logout, forceKill, wake, getQrCode, requestPairingCode, setOnlinePresence, stats                                                                                                                                 |
...
| `wake`               | `wake(id)`                     | Resume a session hibernated after inactivity; no QR scan (Unisoft fork). **OPERATOR**                                                                                                                                                                                                                                                                           |
...
| `wake`                 | `wake(session_id) -> SessionResponse`                           | Resume a session hibernated after inactivity; no QR scan (Unisoft fork). **OPERATOR**                                                                                                                                                                                                                                                                           |
...
| `wake`               | `wake(string $id): array`                            | Resume a session hibernated after inactivity; no QR scan (Unisoft fork). **OPERATOR**                                                                                                                                                                                                                                                                           |
