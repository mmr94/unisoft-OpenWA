...
class SessionsResource
{
    ...
    /**
     * Resume a session hibernated after inactivity (Unisoft fork). No QR scan is involved; the call
     * returns as soon as the engine is launching.
     *
     * @return array<string,mixed>
     */
    public function wake(string $id): array
    {
        return $this->http->request('POST', "/api/sessions/{$this->http->encodeSegment($id)}/wake");
    }
